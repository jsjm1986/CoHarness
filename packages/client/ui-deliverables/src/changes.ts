...
/** Cache namespace for summaries read through the owning Session’s workspaceChanges RPC. */
export const CHANGED_FILES_PATH = '/api/changes.summary'

/** Cache namespace for historical comparisons read through workspaceChanges RPC. */
export const CHANGES_DIFF_PATH = '/api/changes.diff'

/** State namespace for authorized host.openPath actions on changed files. */

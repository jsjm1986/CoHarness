 ...
 * @returns the display name and admin flag, or undefined when no name is readable.
 */
...
/**
 * Detect the durable model-visible attribution notice that precedes a project participant message.

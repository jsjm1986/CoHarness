...
export const zh = {
  ...
  'input.sessionSettings': '会话设置',
  'input.sessionModel': '模型',
  'input.sessionReasoning': '思考等级',
  'input.sessionPermission': '权限',
  'input.sessionSettingsClose': '关闭会话设置',
  ...
  'document.attach': '添加图片或文档',
  'document.browse': '从文档库选择',
  'document.pending': '待发送文档',
  'document.uploading': '上传中 {percent}%',
  'document.ready': '已就绪',
  'document.failed': '上传失败',
  'document.retry': '重试上传',
  'document.retryNamed': '重试上传 {name}',
  'document.remove': '移除文档',
  'document.removeNamed': '移除文档 {name}',
  'document.serviceUnavailable': '文档上传服务不可用',
  ...
  'settings.enter.loading': '正在读取设置…',
  'settings.enter.saving': '保存中…',
  'settings.enter.saveFailed': '设置未能保存，请重试。',
  'settings.enter.projectReadOnly': '项目空间设置由项目运行时管理，请切换到个人空间修改个人偏好。',
  'settings.enter.providerReadOnly': '本部署的设置为只读。',
  'settings.enter.accountReadOnly': '此偏好属于当前账户，但账户存储暂时不可写。',
  'settings.enter.organizationReadOnly': '此偏好由组织管理员管理。',
  'settings.enter.deploymentReadOnly': '此偏好由部署管理员管理。',
  'settings.enter.unavailable': '本部署未提供可持久化的设置。',
  'access.preset.readOnly': '仅可查看',
  'access.preset.workspaceWrite': '工作区内修改',
  'access.preset.fullAccess': '完全权限',
  'access.unavailableLabel': '不可用',
  'access.currentUnavailable': '当前已选择 {name}，但此账户无法使用。请选择普通权限模式。',
  'access.unavailable.unverified': '暂时无法确认账户资格，请重新连接后重试。',
  'access.unavailable.admin-required': '仅管理员可选择完全权限。',
  'access.unavailable.auto-ineligible': '此账户没有 Auto 资格，请选择普通权限模式。',
  ...
  'workspace.discard.cancel': '留在当前会话',
  'workspace.discard.confirm': '放弃并切换',
  'session.hierarchy': '会话层级',
  'details.title': '详情',
  'details.close': '关闭详情',
  'details.empty': '点击消息流中的工具行查看详情',
  'details.notFound': '会话记录中未找到该调用',
  'details.loading': '正在读取调用详情…',
  'details.retry': '重试读取',
  'details.input': '输入',
  'details.output': '输出',
  'details.running': '运行中…',
  ...
  'chat.expandingHistory': '正在整理当前对话…',
  ...
  'settings.display.title': '对话显示',
  'settings.display.description': '调整对话内容宽度和文字大小',
  'settings.display.width': '内容宽度',
  'settings.display.widthValue': '{value}px',
  'settings.display.fontSize': '文字大小',
  'settings.display.fontSizeValue': '{value}px',
  'settings.display.loading': '正在读取显示设置…',
  'settings.display.saving': '保存显示设置…',
  'settings.display.saveFailed': '显示设置未能保存，请重试。',
  'settings.display.unavailable': '本部署未提供可持久化的显示设置。',
  'settings.display.widthHandle': '调整对话内容宽度',
  'settings.display.fill': '占满',
  'message.systemPrompt': '系统提示词',
  'message.turnProcess.toolCalls.one': '{count} 次工具调用',
  'message.turnProcess.toolCalls.other': '{count} 次工具调用',
  'message.turnProcess.messages.one': '{count} 条中间消息',
  'message.turnProcess.messages.other': '{count} 条中间消息',
  'message.turnProcess.subagents.one': '{count} 个子智能体',
  'message.turnProcess.subagents.other': '{count} 个子智能体',
  'message.turnProcess.thoughtForAWhile': '过程内容',
...
export const en = {
  ...
  'number.groupSeparator': ',',
  'view.chat': 'Chat',
  'viewport.resize': 'Resize conversation panes',
  ...
  'input.sessionSettings': 'Session settings',
  'input.sessionModel': 'Model',
  'input.sessionReasoning': 'Thinking level',
  'input.sessionPermission': 'Permission',
  'input.sessionSettingsClose': 'Close session settings',
  ...
  'document.attach': 'Add images or documents',
  'document.browse': 'Choose from Documents',
  'document.pending': 'Pending documents',
  'document.uploading': 'Uploading {percent}%',
  'document.ready': 'Ready',
  'document.failed': 'Upload failed',
  'document.retry': 'Retry upload',
  'document.retryNamed': 'Retry upload {name}',
  'document.remove': 'Remove document',
  'document.removeNamed': 'Remove document {name}',
  'document.serviceUnavailable': 'Document upload service unavailable',
  ...
  'stats.details': 'Session statistics',
  ...
  'settings.enter.loading': 'Loading settings…',
  'settings.enter.saving': 'Saving…',
  'settings.enter.saveFailed': 'The setting could not be saved. Try again.',
  'settings.enter.projectReadOnly': 'Project settings are managed by the runtime. Switch to Personal to edit your preferences.',
  'settings.enter.providerReadOnly': 'This deployment stores settings read-only.',
  'settings.enter.accountReadOnly': 'This preference belongs to the account, but account storage is currently read-only.',
  'settings.enter.organizationReadOnly': 'This preference is managed by the organization administrator.',
  'settings.enter.deploymentReadOnly': 'This preference is managed by the deployment administrator.',
  'settings.enter.unavailable': 'This deployment does not provide persistent settings.',
  ...
  'workspace.discard.cancel': 'Stay in current session',
  'workspace.discard.confirm': 'Discard and switch',
  ...
  'details.notFound': 'This call was not found in the Session log',
  'details.loading': 'Loading call details…',
  'details.retry': 'Retry read',
  'details.input': 'Input',
  ...
  'chat.expandingHistory': 'Updating the current conversation…',
  ...
  'settings.transcript.normal': 'Normal',
  'settings.transcript.compact': 'Compact',
  'settings.display.title': 'Conversation display',
  'settings.display.description': 'Adjust transcript width and text size',
  'settings.display.width': 'Content width',
  'settings.display.widthValue': '{value}px',
  'settings.display.fontSize': 'Text size',
  'settings.display.fontSizeValue': '{value}px',
  'settings.display.loading': 'Loading display settings…',
  'settings.display.saving': 'Saving display settings…',
  'settings.display.saveFailed': 'Display settings could not be saved. Try again.',
  'settings.display.unavailable': 'Persistent display settings are unavailable in this deployment.',
  'settings.display.widthHandle': 'Adjust transcript content width',
  'settings.display.fill': 'Fill',
  ...
  'message.turnProcess.messages.one': '{count} intermediate message',
  'message.turnProcess.messages.other': '{count} intermediate messages',
  ...
  'message.turnError.persistence': 'The session could not be saved. Please try again; contact an administrator if the problem continues.',
  ...
  'row.input': 'IN',
  'row.output': 'OUT',
  'row.openDetails': 'Open details in sidebar',
  'row.inspect': 'Inspect',

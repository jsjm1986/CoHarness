...
/** Draft and browser-owned attachment mutations shared by action faces. */
interface InputDraftActions {
...
export interface SessionInput extends InputTarget, InputDraftActions {
  /**

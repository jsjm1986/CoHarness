...
describe('TurnUsageDisclosure', () => {
  it('shows a compact exact summary and expands provider facts', () => {
  ...
  it('omits optional facts when they are unavailable', () => {
    const view = render(<TurnUsageDisclosure usage={{ uncachedInputTokens: 120, outputTokens: 30, totalTokens: 150 }} t={t} />)
  ...
  it('keeps a partial cache hit below 100 and toggles from the keyboard', () => {
    const view = render(
      <TurnUsageDisclosure
        usage={{ uncachedInputTokens: 1, cacheReadTokens: 999, outputTokens: 100, totalTokens: 1_100 }}
        t={t}
      />,
    )

...
import { IconCheckOutline16, MobileSheetBackdrop, RiskConfirmation, useAnchoredMaxHeight } from '@deepseek-ai/dsh-client-ui-primitives'
  ...
  return (
    <>
      {state.confirming === null && (
        <>
          <MobileSheetBackdrop onClose={() => { popup.dismiss() }} />
          <div
            ref={cardRef}
            className={css.card}
            style={{ maxHeight }}

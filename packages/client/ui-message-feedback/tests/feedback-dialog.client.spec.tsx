...
describe('FeedbackDialog', () => {
  it('owns the conversation-log disclosure and stability category in both supported locales', () => {
    expect(zh['dialog.hint']).toBe('填写详情以帮助我们改进体验。提交后可能按管理员的共享策略发送当前对话日志。')
    expect(en['dialog.hint']).toBe('Add details to help us improve. Submitting may share this conversation log under the administrator’s sharing policy.')

...
export const zh = {
  ...
  'web.loopback': 'localhost 和回环地址指当前访问者的机器，不是 Gateway 或 SSH 主机。',
...
export const en = {
  ...
  'web.loopback': 'Localhost and loopback addresses refer to your machine, not the Gateway or SSH host.',

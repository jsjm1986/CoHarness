/** Controller for one Browser tab's application-known navigation. */
import type { BrowserAddressFailure, BrowserTarget } from './url.ts'
import { MAX_BROWSER_HISTORY, emptyBrowserState, currentBrowserEntry, canBrowserGoBack, canBrowserGoForward } from '../contract/navigation.ts'
import type { BrowserTabState, BrowserHistoryEntry } from '../contract/navigation.ts'
export { MAX_BROWSER_HISTORY } from '../contract/navigation.ts'
export type { BrowserTabState, BrowserHistoryEntry, BrowserNavigationStatus, BrowserFailure } from '../contract/navigation.ts'
...
export class BrowserNavigation {
  ...
  static current(state: BrowserTabState | undefined): BrowserHistoryEntry | undefined {
    return currentBrowserEntry(state)
  }
  ...
  static canGoForward(state: BrowserTabState): boolean {
    return canBrowserGoForward(state)
  }

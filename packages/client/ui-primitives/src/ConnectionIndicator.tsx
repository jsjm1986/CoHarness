 ...
 * @param props - state, localized labels, and the immediate reconnect action.
...
export function ConnectionIndicator({
  ...
  const sizeLabels = (
    <>
      ...
      <span className={css.sizeLabel} aria-hidden="true">{connectingLabel}<span className={css.dots}>...</span></span>

 ...
 */
export const INLINE_SAFE = /^(?:@deepseek-ai\/dsh-(host-apiproxy|file-reference|session|llm|tools|brand|client-userdoc-upload|util-crypto|util-values)(\/|$)|@deepseek-ai\/dsh-agent-presets\/display$)/

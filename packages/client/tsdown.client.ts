 ...
 */
export const INLINE_SAFE = /^(?:@deepseek-ai\/dsh-(host-apiproxy|file-reference|session|llm|tools|brand|client-userdoc-upload|util-crypto|util-values|typert-protocol)(\/|$)|@deepseek-ai\/dsh-agent-presets\/display$|@deepseek-ai\/dsh-session-format\/surface$)/

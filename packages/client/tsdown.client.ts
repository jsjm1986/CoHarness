 ...
 */
export const INLINE_SAFE = /^(?:@deepseek-ai\/dsh-(host-apiproxy|file-reference|session|llm|tools|brand|client-userdoc-upload|util-crypto)(\/|$)|@deepseek-ai\/dsh-agent-presets\/display$)/

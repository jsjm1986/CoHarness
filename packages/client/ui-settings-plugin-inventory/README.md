...
- **Read-only inventory** — the optional preset projection adds composition provenance but the tab still has no current-browser activation diagnosis or plugin mutation controls.

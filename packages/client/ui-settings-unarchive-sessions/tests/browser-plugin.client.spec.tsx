...
import type { IWorkspaces, SessionId } from '@deepseek-ai/dsh-client-runtime/client'
...
async function bench() {
  ...
  ctx.provide('workspaces', { unarchiveSession } as unknown as IWorkspaces)
...
describe('ui-settings-unarchive-sessions browser plugin', () => {
  ...
  it('declares only the services used by the page and the archive write', () => {
    expect(inject).toEqual(['slots', 'locale', 'workspaces'])
  })

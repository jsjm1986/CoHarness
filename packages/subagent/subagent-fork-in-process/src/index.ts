...
class ForkInProcessProvider implements SubagentProvider {
  ...
  // `send_message` tool and prompt section precede the inherited history,
  // defeating the prefix reuse a fork exists for. Reopening needs a
  // byte-identical child system prompt and tool schemas; see issue #2124 and

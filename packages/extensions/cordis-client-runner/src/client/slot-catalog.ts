...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-conversation SystemPromptNodeView key \'system-prompt\'',
      'client-ui-conversation TurnProcessNodeView key \'turn-process\'',
  ...
  },
  {
    ...
    occupants: [
      'client-ui-collaboration ReadOnlyComposer',
  ...
  },
  {
    ...
    declaredBy: 'an entry in \'conversation.pane\' (client-ui-conversation), so it exists while that entry is mounted',
    occupants: [
      'client-ui-conversation StatsPills id \'stats\'',
    ],
    replaceRisk: 'none',
  ...
  },
  {
    ...
    source: 'packages/client/ui-input-trigger/src/client/slots.ts:25',
  },
  {
  ...
  },
  {
    ...
    kind: 'single',
    scope: 'session-maybe',
    summary: 'One explicit Session pane rendered by the conversation viewport.',
    doc: 'One explicit Session pane rendered by the conversation viewport.',
    registerOptions: [],
    ownerProps: [
  ...
  },
  {
    ...
    kind: 'single',
    scope: 'session',
    summary: 'Auxiliary-panel control bound to this exact conversation pane.',
    doc: 'Auxiliary-panel control bound to this exact conversation pane.',
    registerOptions: [],
    ownerProps: [],
    ownerPropsReferences: [],
    standardProps: [
  ...
  },
  {
    ...
    hookContext: '',
    slotInject: '',
    declaredBy: 'an entry in \'sidebar.workspaces.workbench\' (client-ui-workbench), so it exists while that entry is mounted',
    occupants: [
      'client-ui-conversation WorkbenchDisplayRow',
    ],
    replaceRisk: 'shadows-shipped-ui',
  ...
  },
  {
    ...
    kind: 'single',
    scope: 'root',
    summary: 'Empty state rendered when the workbench has no selected panes.',
  ...
  },
  {
    ...
    kind: 'list',
    scope: 'session',
    summary: 'Per-pane header actions contributed by the workbench plugin.',
    doc: 'Per-pane header actions contributed by the workbench plugin.',
    registerOptions: [
      {
        name: 'id',
        requirement: 'required',
  ...
  },
  {
    ...
    kind: 'single',
    scope: 'root',
    summary: 'Workbench controls rendered above the multi-pane surface.',
    doc: 'Workbench controls rendered above the multi-pane surface.',
    registerOptions: [],
    ownerProps: [
  ...
  },
  {
    ...
    kind: 'single',
    scope: 'root',
    summary: 'Single auxiliary-panel root; owns its Session routing.',
    doc: 'Single auxiliary-panel root; owns its Session routing.',
    registerOptions: [],
    ownerProps: [
  ...
  },
  {
    ...
    kind: 'list',
    scope: 'root',
    summary: 'Ordered extension area after the provider list and add controls.',
    doc: 'Ordered extension area after the provider list and add controls.',
    registerOptions: [
      {
        name: 'id',
        requirement: 'required',
    ...
    source: 'packages/client/ui-settings-models/src/client/slot-contract.ts:15',
  },
  {
    key: 'settings.models.provider-card',
    kind: 'keyed',
    scope: 'root',
    summary: 'Extension area inside each provider card, keyed by settings namespace.',
    doc: 'Extension area inside each provider card, keyed by settings namespace.',
    registerOptions: [
      {
        name: 'key',
        requirement: 'required',
    ...
    source: 'packages/client/ui-settings-models/src/client/slot-contract.ts:9',
  },
  {
  ...
  },
  {
    ...
    declaredBy: 'an entry in \'root\' (client-ui-layout), so it exists while that entry is mounted',
    occupants: [
      'client-ui-sidebar-right ExpandButton id \'auxiliary-sidebar\'',
  ...
  },
  {
    ...
    kind: 'list',
    scope: 'root',
    summary: 'Optional actions stacked above Settings at the sidebar foot.',
    doc: 'Optional actions stacked above Settings at the sidebar foot. Declared by\nthis package\'s \'sidebar\' entry; each action receives only the column state.',
    registerOptions: [
      {
        name: 'id',
        requirement: 'required',
    ...
    declaredBy: 'an entry in \'sidebar\' (client-ui-sidebar), so it exists while that entry is mounted',
    occupants: [
      'client-ui-collaboration ScopeControl id \'collaboration-scope\'',
      'client-ui-documents DocumentsButton id \'documents\'',
  ...
  },
  {
    ...
    keyDomain: 'open: any string the owner dispatches (no compile-time key set), already taken: tool-details, workspace-file',
    ...
    occupants: [
      ...
      'client-ui-workbench WorkspaceFileTab key \'workspace-file\'',
    ],
    replaceRisk: 'shadows-shipped-ui',
  ...
  },
  {
    ...
    kind: 'list',
    scope: 'root',
    summary: 'Optional compact actions rendered beside the Settings trigger.',
    doc: 'Optional compact actions rendered beside the Settings trigger. The\nshell owns the row geometry; each action owns its icon, form, tooltip,\nand accessible name.',
    registerOptions: [
      {
        name: 'id',
        requirement: 'required',
    ...
    declaredBy: 'an entry in \'sidebar\' (client-ui-sidebar), so it exists while that entry is mounted',
    occupants: [
      'client-ui-collaboration LogoutButton id \'collaboration-logout\'',
    ],
    replaceRisk: 'none',
  ...
  },
  {
    ...
    kind: 'single',
    scope: 'root',
    summary: 'Workbench panel hole under the sidebar browsing region (declared by the WorkspaceBrowser entry).',
    doc: 'Workbench panel hole under the sidebar browsing region (declared by the WorkspaceBrowser entry).',
    registerOptions: [],
    ownerProps: [
    ...
    declaredBy: 'an entry in \'sidebar.workspaces\' (client-ui-workspace), so it exists while that entry is mounted',
    occupants: [
      'client-ui-workbench WorkbenchSidebar',
    ],
    replaceRisk: 'shadows-shipped-ui',

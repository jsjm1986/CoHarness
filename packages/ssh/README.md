...
- [POSIX SSH decision](../../.agents/notes/implemented/architecture/2026-09-23-ssh-execution-providers.md) — alternatives, consequences and verification requirements.

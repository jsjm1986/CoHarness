...
class ExecutionFileSystem extends LocalFileSystem {
  override processPathFromHostPath(): undefined { return undefined }
}

describe('real Loader composition', () => {
  it.each(process.platform === 'win32' ? [false] : [false, true])('records a turn through the loaded execution providers (isolated paths: %s)', async (isolated) => {

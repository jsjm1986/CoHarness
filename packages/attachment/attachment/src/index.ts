...
export abstract class AttachmentStore extends Service {
  ...
  async saveImages(inputs: readonly SaveImageAttachment[]): Promise<readonly ImageAttachmentRef[]> {
    // Keep the shared batch contract usable by structural test doubles and
    // adapters that delegate to this base implementation with `.call(...)`.
    AttachmentStore.prototype.validateImageBatch.call(this, inputs)

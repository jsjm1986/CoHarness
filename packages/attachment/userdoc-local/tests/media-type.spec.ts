...
describe('mediaTypeFor', () => {
  it('recognizes the extensions a browser can render inline', () => {
    ...
    expect(mediaTypeFor('config.yaml')).toBe('application/x-yaml')
    expect(mediaTypeFor('feed.xml')).toBe('application/xml')
    expect(mediaTypeFor('script.js')).toBe('application/javascript')

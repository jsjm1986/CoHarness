...
export class MemoryCredentials extends CredentialProvider {
  ...
  protected override describeOwned(_ref: CredentialRef): Promise<CredentialInfo> {
    return Promise.resolve({ configured: false, writable: true })
  }

  protected override setOwned(_ref: CredentialRef, _value: string): Promise<void> {
    return Promise.resolve()
  }

  protected override unsetOwned(_ref: CredentialRef): Promise<void> {
    return Promise.resolve()
  }

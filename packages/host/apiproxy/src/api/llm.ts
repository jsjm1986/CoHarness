 ...
 * (which providers CAN be configured, where their settings live, and who
 * controls them) with the live route registry; `llm.models` is the session-independent model catalog

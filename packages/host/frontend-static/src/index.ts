 ...
 * runs through the webserver's index render (structured rows, then raw taps).
 * The dist location is workspace knowledge of the composing
 ...
 * @param renderIndex - produces the index.html body (index injection) for

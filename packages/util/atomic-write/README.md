...
- **Windows replacement retries transient interference** (`EACCES`, `EBUSY`, or `EPERM`) for a bounded interval while the complete temp file remains available for the rename.

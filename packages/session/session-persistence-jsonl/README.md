...
| `maxPendingEvents` | positive integer (default `10,000`) | Maximum events retained by one live session's write controller; a producer beyond the limit is rejected. |

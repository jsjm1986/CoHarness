...
import { BlockAssembler, createUserMessage, ToolCallId, CONTEXT_WINDOW_EXCEEDED_CODE, EMPTY_RESPONSE_CODE, createMessage } from '@deepseek-ai/dsh-llm'
...
describe('mapStopReason / mapUsage', () => {
  ...
  it('maps routable HTTP-ish error messages to stable codes', () => {
    ...
    expect(mapStopReason(assistant({ stopReason: 'error', errorMessage: 'HTTP 403: INSUFFICIENT_BALANCE' })))

...
describe('cancellation and integration teardown', () => {
  // dsh-llm closes a caller-cancelled adapter stream before the late review
  // outcome can be read, so every outcome reaches the gate as an unread
  // decision and fails closed with AUTO_REVIEW_DENIED.
  it.each([
    { outcome: 'allow', expectedCode: 'AUTO_REVIEW_DENIED' },

...
export interface RuntimeProcessOptions extends Pick<HarnessClientOptions,
  'maxLineBytes' | 'maxPendingRequests' | 'maxConcurrentIncoming' | 'maxOutputBytes' | 'maxNotificationQueue'> {
  command: string
  args: string[]
  cwd?: string

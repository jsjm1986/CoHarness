...
The latest upstream comparison is recorded in [`UPGRADE-PLAN-dsh-v0.1.5-rc.2.md`](upgrades/plans/UPGRADE-PLAN-dsh-v0.1.5-rc.2.md), with its machine-readable decision inventory in [`UPGRADE-MANIFEST-dsh-v0.1.5-rc.2.json`](upgrades/manifests/UPGRADE-MANIFEST-dsh-v0.1.5-rc.2.json).

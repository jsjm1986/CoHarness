...
The current Trajectory acceptance limit is 850 ms, represented by a 680 ms target with the shared 1.25× headroom. The former 650 ms ceiling (520 ms target) sat inside the measured hosted distribution: run 35095609422 recorded medians of 666.651723 ms and 630.843184 ms, and fork runs 36208631023 and 36215749263 record medians of 629.515400 ms and 658.402183 ms with per-sample values spanning 596.868403–664.735862 ms. The target rounds up the largest observed median; recorded samples exercise the accepted range, and the same verdict assertion rejects 851 ms. Other endpoint budgets and workload parameters remain unchanged.

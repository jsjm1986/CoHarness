...
The [verification throughput decision](../process/2026-09-22-pr-verification-throughput.md) adds candidate selection of exact scenario and golden owners plus every smoke. Production components retain these group rules, and the default shadow union retains previous coverage until the reviewed switch. This note remains authoritative for group ownership and the common smoke inventory.

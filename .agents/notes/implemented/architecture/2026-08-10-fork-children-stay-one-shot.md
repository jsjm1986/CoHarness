...
- The base and headless profiles keep one-shot fork, while the Web app agent presets exercise continuable fork without a child-only request-head addition.

...
This decision partially supersedes the tool selection in [the bare minimal runtime](../feature/2026-08-11-minimal-profiles-bare-two-tool-runtime.md). That note retains authority for prompt ownership and no-compaction behavior; the shared base patch continues to ship `str_replace_editor`, so base-backed profiles keep a second file-editing interface. [The application architecture](../../../../docs/architecture.md) owns profile launch and bundle layering.

...
- Generic rows retain `bodyRaw` and invoke `formatToolBody` only after expansion; the collapsed list does not allocate a pretty-printed copy of a large argument payload.

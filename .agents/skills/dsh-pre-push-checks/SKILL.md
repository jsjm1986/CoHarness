...
- **Documentation, Agent Notes, catalogs, or doc-linked comments:** run `pnpm run test:docs` for the 19-leaf documentation quick pass; reserve `pnpm run doc-sync` for the full acceptance lane CI already runs.

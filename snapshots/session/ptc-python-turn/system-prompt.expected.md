...
class PresentArgsFiles(TypedDict):
    # Path of an existing regular file. Relative paths use the Session working directory.
    path: str
    # Brief description for the user.
    description: NotRequired[str]

class PresentArgs(TypedDict):
    files: list[PresentArgsFiles]
    # Additional keys beyond those declared are allowed.

class PresentOutputFiles(TypedDict):
    path: str
    description: NotRequired[str]

class PresentOutput(TypedDict):
    turn: int
    files: list[PresentOutputFiles]

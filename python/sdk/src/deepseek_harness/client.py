...
class HarnessClient:
    ...
    def __init__(self, config: HarnessConfig | None = None, *, _launch_args: tuple[str, ...] | None = None) -> None:
        ...
        _validate_timeout(self.config.initialize_timeout_seconds, "initialize_timeout_seconds")
    ...
    def initialize(
        ...
        *,
        ...
        try:
            return self.request("initialize", payload, response_model=InitializeResponse, timeout_seconds=self.config.initialize_timeout_seconds)

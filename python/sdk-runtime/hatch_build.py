...
class RuntimeBuildHook(BuildHookInterface):
    ...
    def initialize(self, version: str, build_data: dict[str, object]) -> None:
        ...
        # New wheels contain the canonical carrier name only. Legacy names are
        # accepted by runtime lookup, but are never emitted into a fresh wheel.
        runtime_files = sorted(runtime_dir.glob("deepseek-harness-sdk-runtime-*") if runtime_dir.is_dir() else [])
        expected_files = (

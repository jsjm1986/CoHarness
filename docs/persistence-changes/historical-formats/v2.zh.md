...
[V2 codec](../../../packages/session/session-persistence-jsonl/src/format.ts)负责每行一个事件的编码、范围编码的来源引用，以及从 `session/end-seed` 标记推导的继承切点。[V2 到 V3 规范](../../../packages/session/session-format/README.zh.md)负责系统消息插入、PTC 事件名称与规范信封转换。

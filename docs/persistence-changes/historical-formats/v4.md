---
description: "Accepted CoHarness V4 declarations from PR 218 before the V5 successor."
...
This complete inventory preserves the accepted declarations in [PR #218](https://github.com/jsjm1986/CoHarness/pull/218), without later execution-authority additions or the V5 header correction.

## Source evidence

PR #218 introduced the V4 writer and its accepted [change record](../2026-09-21-v4.md). The logical Session header declares optional `draft`, while its physical JSONL declaration omits it. The V4 codec delegates to the V3 encoder, which emits a boolean `draft` when supplied; the JSONL reader’s narrower whitelist rejected that emitted field. V5 repairs the mismatch without rewriting this historical declaration.
...
source:
  pullRequest: 218
roots:
  "SessionHeader": "50d61ac382aac4970cca9730794b2275c34eb7d567dd5cff80d4a5e200d3b6c4"
  ...
  "event:agent/inbox/spliced": "e6f27d24ac3ffd66f6e3fcf1a39c10fd870922aeddd7437d46d93b535ec39b0f"
  ...
  "event:assistant/attempt": "7d9a704c4219e96e51ec5578836eeb33a2c211854c5d805ad03e8582a43b061b"
  "event:assistant/message": "7276d8e1bee84b4824a9ffd8ccaae87625b5247a400cf943d3cf7c143ff528ed"
  ...
  "event:feedback/message-delete": "7641b74a731237003b2cff1e72e21ea4b9c1b23e59f1c83a337dab25b2932d2f"
  ...
  "event:permission/preset": "7271e4b771406aaf06014c2269edd6cb68055bb8b8686571730813ce0ababc22"
  ...
  "event:session/title-llm-request": "9d7b4c0e644a269a1d7e22e7f15a40a87c63d0fca368ab2343faaca0b7f803f8"
  ...
  "event:team/message/queued": "ac5065b914937f6b64f923068f14572e01ac865c825eb1c62270e135f2bed558"
  ...
  "event:user/message": "9630c2fde0691463fa3ce1b551fbfb8575f90629b3d640cd78719e757b52179e"
  "event:userdoc/attached": "4e53f6719003dd537e20c4d02ea7a64c729a8e313536392fbaecf94e19e7de71"
...
The [complete machine inventory](v4.schema.json) contains 60 roots and 488 reachable types. Digests include all referenced fields; source names and paths describe the selected historical tree.

### Persistence type fingerprints

| Root | Kind | SHA-256 | Resolved type |
|---|---|---|---|
| `SessionHeader` | header | `50d61ac382aac4970cca9730794b2275c34eb7d567dd5cff80d4a5e200d3b6c4` | [`packages/core/session/src/types.ts#SessionHeader`](#persistence-type-packagescoresessionsrctypestssessionheader) |
...
| `event:agent/inbox/spliced` | event | `e6f27d24ac3ffd66f6e3fcf1a39c10fd870922aeddd7437d46d93b535ec39b0f` | [`event:agent/inbox/spliced`](#persistence-type-eventagentinboxspliced) |
...
| `event:session/title-llm-request` | event | `9d7b4c0e644a269a1d7e22e7f15a40a87c63d0fca368ab2343faaca0b7f803f8` | [`event:session/title-llm-request`](#persistence-type-eventsessiontitle-llm-request) |
...
| `event:team/message/queued` | event | `ac5065b914937f6b64f923068f14572e01ac865c825eb1c62270e135f2bed558` | [`event:team/message/queued`](#persistence-type-eventteammessagequeued) |
...
| `event:user/message` | event | `9630c2fde0691463fa3ce1b551fbfb8575f90629b3d640cd78719e757b52179e` | [`event:user/message`](#persistence-type-eventusermessage) |
...
SHA-256: `e6f27d24ac3ffd66f6e3fcf1a39c10fd870922aeddd7437d46d93b535ec39b0f`
...
SHA-256: `94f9502e742e2821b67f256bf15ebb38e4f6c32d98a624f0c57656905d61da90`
...
SHA-256: `a759e3995a70f930abbbc1b56b87dc6a6a5fc30e639c86c236f8fed40fac13f5`
...
Sources: `packages/core/session/src/types.ts` · `packages/interaction/commands/src/types.ts` · `packages/llm/llm/src/message.ts` · `packages/session/session-title/src/index.ts`
...
Sources: `packages/host/apiproxy/src/api/sessions.ts`

| Property | Presence | Type |
|---|---|---|
| `clientTimeZone` | optional | `string` |
| `documents` | optional | [`event:agent/inbox/spliced.data.inserted[0].source[10].documents`](#persistence-type-eventagentinboxspliceddatainserted0source10documents) |
| `kind` | required | `"user"` |
...
<a id="persistence-type-eventagentinboxspliceddatainserted0source10documents"></a>

#### `event:agent/inbox/spliced.data.inserted[0].source[10].documents`
...
<a id="persistence-type-eventagentinboxspliceddatainserted0source10documents0representation0"></a>

#### `event:agent/inbox/spliced.data.inserted[0].source[10].documents[0].representation[0]`

SHA-256: `1e788d9e90f320b51cba113f9dbed35cae28a903fec07a9cd4c52605d2a0c0dd`

Sources: `packages/attachment/userdoc/src/types.ts`
...
<a id="persistence-type-eventagentinboxspliceddatainserted0source10documents0representation1"></a>

#### `event:agent/inbox/spliced.data.inserted[0].source[10].documents[0].representation[1]`
...
<a id="persistence-type-eventagentinboxspliceddatainserted0source10participantrole"></a>

#### `event:agent/inbox/spliced.data.inserted[0].source[10].participant.role`
...
<a id="persistence-type-eventagentinboxspliceddatainserted0source10participantscope"></a>

#### `event:agent/inbox/spliced.data.inserted[0].source[10].participant.scope`

SHA-256: `de4d0da9d9b46f42f9c05e72d6a469a83ac00d89aed6d1a1a0311206cd9666ba`

One of:

- [`event:agent/inbox/spliced.data.inserted[0].source[10].participant.scope[1]`](#persistence-type-eventagentinboxspliceddatainserted0source10participantscope1)
- [`event:agent/inbox/spliced.data.inserted[0].source[10].participant.scope[0]`](#persistence-type-eventagentinboxspliceddatainserted0source10participantscope0)

<a id="persistence-type-eventagentinboxspliceddatainserted0source10participantscope0"></a>

#### `event:agent/inbox/spliced.data.inserted[0].source[10].participant.scope[0]`
...
<a id="persistence-type-eventagentinboxspliceddatainserted0source10participantscope1"></a>

#### `event:agent/inbox/spliced.data.inserted[0].source[10].participant.scope[1]`
...
| `mode` | required | [`event:agent/inbox/spliced.data.inserted[0].source[10].participant.scope[1].mode`](#persistence-type-eventagentinboxspliceddatainserted0source10participantscope1mode) |
| `projectId` | required | `number` |
| `projectName` | required | `string` |

<a id="persistence-type-eventagentinboxspliceddatainserted0source10participantscope1mode"></a>

#### `event:agent/inbox/spliced.data.inserted[0].source[10].participant.scope[1].mode`
...
| Property | Presence | Type |
|---|---|---|
| `credentialSource` | optional | `string` |
| `type` | required | `"usage"` |
...
SHA-256: `7641b74a731237003b2cff1e72e21ea4b9c1b23e59f1c83a337dab25b2932d2f`
...
SHA-256: `d525a7f79ee82260eab907f84ae5b648afb238002b0bc7c9be8598637b41f214`

Sources: `packages/feedback/message-feedback/src/index.ts`
...
| Property | Presence | Type |
|---|---|---|
| `data` | required | [`packages/host/apiproxy/src/api/sessions.ts#ModelSelection`](#persistence-type-packageshostapiproxysrcapisessionstsmodelselection) |
| `ignorable` | optional | `true` |
| `seq` | required | `number` |
| `time` | required | `number` |
...
SHA-256: `7271e4b771406aaf06014c2269edd6cb68055bb8b8686571730813ce0ababc22`
...
SHA-256: `ebaac53bc4e8eb2ef8870c1ac58976a8a54987e3e412126b9f617f42bcd49829`

Sources: `packages/interaction/permission-presets/src/index.ts`

| Property | Presence | Type |
|---|---|---|
| `origin` | optional | [`event:permission/preset.data.origin`](#persistence-type-eventpermissionpresetdataorigin) |
| `preset` | required | `string` |

<a id="persistence-type-eventpermissionpresetdataorigin"></a>

#### `event:permission/preset.data.origin`

SHA-256: `6c5d5215ad72616561350f3be63f968e321e75360d9de2a9408994d45d3be76f`
...
| Property | Presence | Type |
|---|---|---|
| `data` | required | [`packages/session/session-title/src/index.ts#SessionTitleEventData`](#persistence-type-packagessessionsession-titlesrcindextssessiontitleeventdata) |
| `ignorable` | optional | `true` |
| `seq` | required | `number` |
| `time` | required | `number` |
...
SHA-256: `9d7b4c0e644a269a1d7e22e7f15a40a87c63d0fca368ab2343faaca0b7f803f8`
...
SHA-256: `bae68f63a39a85f238cfa414171171ec381bdb87b321b5057ae1eaafbcc6067a`
...
Sources: `packages/session/session-title/src/index.ts`
...
Array of [`packages/session/session-title/src/index.ts#SessionTitleModelIdentity`](#persistence-type-packagessessionsession-titlesrcindextssessiontitlemodelidentity).
...
SHA-256: `ac5065b914937f6b64f923068f14572e01ac865c825eb1c62270e135f2bed558`
...
SHA-256: `3a464a2d19fc9b2f4cb95aa8eac9d0e353d74f85f9d0230d07ebd3e5a27be3a7`
...
<a id="persistence-type-eventteammessagequeueddatamessagedelivery"></a>

#### `event:team/message/queued.data.message.delivery`
...
Sources: `packages/core/session/src/json.ts`
...
<a id="persistence-type-eventuserdocattached"></a>

#### `event:userdoc/attached`

SHA-256: `4e53f6719003dd537e20c4d02ea7a64c729a8e313536392fbaecf94e19e7de71`

| Property | Presence | Type |
|---|---|---|
| `data` | required | [`packages/context/userdoc-context/src/index.ts#UserDocAttachedEventData`](#persistence-type-packagescontextuserdoc-contextsrcindextsuserdocattachedeventdata) |
| `ignorable` | optional | `true` |
| `seq` | required | `number` |
| `time` | required | `number` |
| `type` | required | `"userdoc/attached"` |

<a id="persistence-type-eventusermessage"></a>

#### `event:user/message`

SHA-256: `9630c2fde0691463fa3ce1b551fbfb8575f90629b3d640cd78719e757b52179e`
...
<a id="persistence-type-inferred"></a>

#### `"inferred"`

SHA-256: `19a9088b778dbc75c9c3158d0145b3e1d3b9bba253821e249f869db82e98b713`
...
<a id="persistence-type-inline"></a>

#### `"inline"`

SHA-256: `a1f74ddf9dd80bc493ef80f8b20b42017ecebd2ededd5098a1708c504181b81b`
...
<a id="persistence-type-packagesattachmentuserdocsrctypestsuserdocpromptattachment"></a>

#### `packages/attachment/userdoc/src/types.ts#UserDocPromptAttachment`

SHA-256: `b25e4f99b7d09116ec51d2926f27c82d7b44dbe4961e147cd95335324921d266`

Sources: `packages/attachment/userdoc/src/types.ts`

| Property | Presence | Type |
|---|---|---|
| `ref` | required | [`packages/attachment/userdoc/src/types.ts#UserDocRef`](#persistence-type-packagesattachmentuserdocsrctypestsuserdocref) |
| `representation` | required | [`packages/attachment/userdoc/src/types.ts#UserDocPromptRepresentation`](#persistence-type-packagesattachmentuserdocsrctypestsuserdocpromptrepresentation) |

<a id="persistence-type-packagesattachmentuserdocsrctypestsuserdocpromptrepresentation"></a>

#### `packages/attachment/userdoc/src/types.ts#UserDocPromptRepresentation`

SHA-256: `c26f1a79f347ec7b53d88296f7f94ab1cdb173556ee93db6c57734e171839491`

Sources: `packages/attachment/userdoc/src/types.ts`

One of:

- [`event:agent/inbox/spliced.data.inserted[0].source[10].documents[0].representation[0]`](#persistence-type-eventagentinboxspliceddatainserted0source10documents0representation0)
- [`event:agent/inbox/spliced.data.inserted[0].source[10].documents[0].representation[1]`](#persistence-type-eventagentinboxspliceddatainserted0source10documents0representation1)

<a id="persistence-type-packagesattachmentuserdocsrctypestsuserdocref"></a>

#### `packages/attachment/userdoc/src/types.ts#UserDocRef`

SHA-256: `995d3369d395b64efb484508352e45fd5348880d480d8107f78daa7366779f77`
...
| Property | Presence | Type |
|---|---|---|
| `imageIndexes` | required | [`SessionEventEnvelope[38].sourceEventSeqs`](#persistence-type-sessioneventenvelope38sourceeventseqs) |
| `seq` | required | `number` |
...
#### `packages/context/userdoc-context/src/index.ts#UserDocAttachedEventData`

SHA-256: `5f7d411466adccfafe175f6255fd8765735256aa5ace69d462614455dc38b183`

Sources: `packages/context/userdoc-context/src/index.ts`
...
SHA-256: `50d61ac382aac4970cca9730794b2275c34eb7d567dd5cff80d4a5e200d3b6c4`
...
SHA-256: `cf0d22eccecc58a09771ccf44a19971bf3ed48505392ddfc36ea629e16878334`
...
<a id="persistence-type-packageshostapiproxysrcapisessionstsauthenticatedparticipant"></a>

#### `packages/host/apiproxy/src/api/sessions.ts#AuthenticatedParticipant`

SHA-256: `ac21aa6c9ecfc9c18ab4e0a1759e1396e29be4f15b3e65250af5f6df01d31794`
...
| `role` | required | [`event:agent/inbox/spliced.data.inserted[0].source[10].participant.role`](#persistence-type-eventagentinboxspliceddatainserted0source10participantrole) |
| `scope` | required | [`event:agent/inbox/spliced.data.inserted[0].source[10].participant.scope`](#persistence-type-eventagentinboxspliceddatainserted0source10participantscope) |
| `userId` | required | `number` |
| `username` | required | `string` |

<a id="persistence-type-packageshostapiproxysrcapisessionstsmodelselection"></a>

#### `packages/host/apiproxy/src/api/sessions.ts#ModelSelection`
...
SHA-256: `0194b5d0f7e358133fc01159557d5bee365fe9dae832777ad4b4ae5551b75c58`
...
SHA-256: `d318ed35bca73633c1bc59273985fd3a14350c23e52ee42751ff76083f8b7137`
...
SHA-256: `1348c03f89682ebedfebba203dc681274e7d41d7af5ad44d0586bccf4fe0bbeb`
...
SHA-256: `6ee11f378ee5f2526a76f24ed3cc2de8f7bfafd0be6a0dadc66c399c1e4dc509`
...
<a id="persistence-type-packagessessionsession-titlesrcindextssessiontitleeventdata"></a>

#### `packages/session/session-title/src/index.ts#SessionTitleEventData`
...
<a id="persistence-type-packagessessionsession-titlesrcindextssessiontitlemodelidentity"></a>

#### `packages/session/session-title/src/index.ts#SessionTitleModelIdentity`

SHA-256: `07e1a58c58b593f507b8e7f25723bb0aa42baae6e00f5ecfddf28cb1e64d3235`

Sources: `packages/session/session-title/src/index.ts` · `packages/subagent/tool-subagent/src/model-selection.ts`
...
<a id="persistence-type-packagessessionsession-titlesrcindextssessiontitlesource"></a>

#### `packages/session/session-title/src/index.ts#SessionTitleSource`
...
<a id="persistence-type-personal"></a>

#### `"personal"`

SHA-256: `177dab0bb552e5b724fe3dd7bcfa8bd9efcf8fe7801b627ab4ed811451eef409`
...
<a id="persistence-type-project"></a>
...
<a id="persistence-type-ro"></a>

#### `"ro"`

SHA-256: `4930fb080cfdd83dbf2d0f2152ce38ce6c83e64043cd4e6824737de5cbce4ed1`
...
SHA-256: `5279a8b1919f003fd3334ccee129518e3d80090b1fa01efd7827eb7cad8a80e5`
...
<a id="persistence-type-selection"></a>

#### `"selection"`

SHA-256: `78d7455eb6b3c8da4d70c104eadd69d4a60df1c449e855517a60673b889e03fa`
...
Sources: `packages/attachment/attachment/src/brand.ts` · `packages/attachment/userdoc/src/brand.ts` · `packages/compaction/compaction/src/brand.ts` · `packages/core/session/src/types.ts` · `packages/experimental/agent-team/src/types.ts` · `packages/feedback/message-feedback/src/types.ts` · `packages/goal/goal/src/types.ts` · `packages/host/apiproxy/src/api/rpc.ts` · `packages/interaction/commands/src/brand.ts` · `packages/interaction/user-approval/src/types.ts` · `packages/llm/llm-retry/src/brand.ts` · `packages/llm/llm/src/brand.ts` · `packages/schedule/schedule/src/types.ts` · `packages/session/session-title/src/index.ts` · `packages/workflow/workflow/src/types.ts`
...
SHA-256: `067adb271a29230cc0ac014126bc87d3d829d5e0945178189e05c78c3edf1e35`
...
The schema was generated from the committed checkpoint and records declared types. It does not assert that the V4 reader accepted every writer output. Migration tests separately cover headers containing `draft` and headers that omit it.

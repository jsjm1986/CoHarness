---
description: "Accepted CoHarness V5 declarations from PR 218 before the V6 successor."
kind: persistence-format
---

# Session V5 persistence format

English | [中文](v5.zh.md)

## Summary

This complete inventory preserves the accepted declarations in [PR #218](https://github.com/jsjm1986/CoHarness/pull/218), before the V6 header correction that follows it.

## Source evidence

PR #218 advanced the writer to V5 with the accepted [change record](../2026-09-22-v5-execution.md): the JSONL reader finally admits the optional `draft` header the V4 writer already emitted, and Session events gained verified Gateway execution identity. The same format window also accepted the declared [deliverables and workspace-changes events](../2026-09-23-deliverables-events.md) as same-version additions. V6 later admits the optional `sshTarget` header without rewriting this declaration.
...
source:
  pullRequest: 218
roots:
  "SessionHeader": "26fe78358faad6a9ef82dbc2a984018533d4dd028ef7997dc70e3827c261aa07"
  "JsonlHeaderLine": "9136dd6271b5aba11b4748a03cb05bdb0cc9b05f17be5af3d87a86406177033c"
  ...
  "event:agent/inbox/spliced": "6a12ecfb066aafd62c6a857c7898e2f8b2237aba3b5856f391d9aa7d521b1fb6"
  ...
  "event:gateway/execution": "a8e61a09f296a93e9ba18c7b01cdd85401500ac6ddba8750cf3cdd75610acf5e"
  ...
  "event:session/title-llm-request": "0735bc4fb1d335aad0b9b8289d5638fa8f7f1f3dc5bd79b501fe5c567f92b867"
  ...
  "event:team/message/queued": "3c172e2172241690c27e5a3fac4d6930ad8bcfe9b7060af088052c8e4332e94e"
  ...
  "event:user/message": "19cb7b6061859227ee6f7f46deb1775629d78ad9d730b69b262e36380227196e"
...
The [complete machine inventory](v5.schema.json) contains 63 roots and 508 reachable types. Digests include all referenced fields; source names and paths describe the selected historical tree.

### Persistence type fingerprints

| Root | Kind | SHA-256 | Resolved type |
|---|---|---|---|
| `SessionHeader` | header | `26fe78358faad6a9ef82dbc2a984018533d4dd028ef7997dc70e3827c261aa07` | [`packages/core/session/src/types.ts#SessionHeader`](#persistence-type-packagescoresessionsrctypestssessionheader) |
...
| `documents` | optional | [`event:agent/inbox/spliced.data.inserted[0].source[11].documents`](#persistence-type-eventagentinboxspliceddatainserted0source11documents) |
| `kind` | required | `"user"` |
...
| `mode` | required | [`event:agent/inbox/spliced.data.inserted[0].source[11].participant.scope[1].mode`](#persistence-type-eventagentinboxspliceddatainserted0source11participantscope1mode) |
...
| Property | Presence | Type |
|---|---|---|
| `data` | required | [`packages/context/execution-authority/src/types.ts#ExecutionEvent`](#persistence-type-packagescontextexecution-authoritysrctypestsexecutionevent) |
| `ignorable` | optional | `true` |
| `seq` | required | `number` |
| `time` | required | `number` |
...
Sources: `packages/context/execution-authority/src/types.ts`
...
<a id="persistence-type-inherit"></a>

#### `"inherit"`

SHA-256: `f3fa240f6fe10814b7d60ab8cebfc0e8d8a07f1088d12e4eac49350be264b894`
...
SHA-256: `26fe78358faad6a9ef82dbc2a984018533d4dd028ef7997dc70e3827c261aa07`
...
| Property | Presence | Type |
|---|---|---|
| `allow` | optional | [`event:agent/inbox/spliced.data.inserted[0].source[12].gatewayExecutionScope.inputs`](#persistence-type-eventagentinboxspliceddatainserted0source12gatewayexecutionscopeinputs) |
| `deny` | optional | [`event:agent/inbox/spliced.data.inserted[0].source[12].gatewayExecutionScope.inputs`](#persistence-type-eventagentinboxspliceddatainserted0source12gatewayexecutionscopeinputs) |
...
| Property | Presence | Type |
|---|---|---|
| `blockedBy` | required | [`event:agent/inbox/spliced.data.inserted[0].source[12].gatewayExecutionScope.inputs`](#persistence-type-eventagentinboxspliceddatainserted0source12gatewayexecutionscopeinputs) |
| `description` | required | `string` |
| `id` | required | `string` |
...
| `writeScopes` | required | [`event:agent/inbox/spliced.data.inserted[0].source[12].gatewayExecutionScope.inputs`](#persistence-type-eventagentinboxspliceddatainserted0source12gatewayexecutionscopeinputs) |
...
| `role` | required | [`event:agent/inbox/spliced.data.inserted[0].source[11].participant.role`](#persistence-type-eventagentinboxspliceddatainserted0source11participantrole) |
| `scope` | required | [`event:agent/inbox/spliced.data.inserted[0].source[11].participant.scope`](#persistence-type-eventagentinboxspliceddatainserted0source11participantscope) |
| `userId` | required | `number` |
...
| `provider` | required | `string` |
| `reasoningEffort` | optional | `string` |
| `stop` | optional | [`event:agent/inbox/spliced.data.inserted[0].source[12].gatewayExecutionScope.inputs`](#persistence-type-eventagentinboxspliceddatainserted0source12gatewayexecutionscopeinputs) |
...
SHA-256: `9136dd6271b5aba11b4748a03cb05bdb0cc9b05f17be5af3d87a86406177033c`
...
Sources: `packages/attachment/attachment/src/brand.ts` · `packages/attachment/userdoc/src/brand.ts` · `packages/compaction/compaction/src/brand.ts` · `packages/context/execution-authority/src/types.ts` · `packages/core/session/src/types.ts` · `packages/experimental/agent-team/src/types.ts` · `packages/feedback/message-feedback/src/types.ts` · `packages/goal/goal/src/types.ts` · `packages/host/apiproxy/src/api/rpc.ts` · `packages/interaction/commands/src/brand.ts` · `packages/interaction/user-approval/src/types.ts` · `packages/llm/llm-retry/src/brand.ts` · `packages/llm/llm/src/brand.ts` · `packages/schedule/schedule/src/types.ts` · `packages/session/session-title/src/index.ts` · `packages/webhook/webhook/src/brand.ts` · `packages/workflow/workflow/src/types.ts`
...
The schema was generated from the committed checkpoint and records declared types. It does not assert that the V5 reader accepted every writer output. Migration tests separately cover headers containing `sshTarget` and headers that omit it.

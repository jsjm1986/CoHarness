...
The [V0/V1 codec](../../../packages/session/session-persistence-jsonl/src/format.ts) owns the shared physical layout, including packed chunks and numeric inherited cuts. The [V1-to-V2 migration reference](../../../packages/session/session-format/README.md) owns chunk consumption, embedded streams, and sequence remapping; those transformations are not inferred from the type digests.

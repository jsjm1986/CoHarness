...
来源为已发布 tag `dsh-v0.1.2-rc.1`，其写入器常量为 0。这是[已收录预发布归档](../releases/README.zh.md)中最后一个 V0 tag；[tag 记录](../releases/dsh-v0.1.2-rc.1.zh.md)保留其发布背景。更早的 V0 tag 还存在其他类型差异，本快照不替代那些记录。
...
[V0/V1 codec](../../../packages/session/session-persistence-jsonl/src/format.ts)负责打包的 Assistant 行与范围编码的来源引用。这些物理 body 编码不是本声明类型目录中的额外根类型。[相邻迁移参考](../../../packages/session/session-format/README.zh.md)负责已接受的历史规范化与拒绝规则。

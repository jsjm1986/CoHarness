...
|---|---|---|---|
| `SessionHeader` | header | `8102d6727bb57bbea3bb78b5622996246ae4609d0bddf332ef0f2c6657493dad` | [`packages/core/session/src/types.ts#SessionHeader`](#persistence-type-packagescoresessionsrctypestssessionheader) |
| `JsonlHeaderLine` | header | `becb738db5b4c2865a69cc40df806519d781feea1ab1b3d177539b5b9188ec66` | [`packages/session/session-persistence-jsonl/src/format.ts#HeaderLine`](#persistence-type-packagessessionsession-persistence-jsonlsrcformattsheaderline) |
...
| `event:agent/inbox/spliced` | event | `989d6d8ca9c21c4c5c0e7bbf88ca575e4165221454524cdeb7dc824fdc6b5b0c` | [`event:agent/inbox/spliced`](#persistence-type-eventagentinboxspliced) |
...
| `event:session/title-llm-request` | event | `4b7fbf29e0ae1e0d95b75903193114fce97ad18351c41a2e06bc287d86e86333` | [`event:session/title-llm-request`](#persistence-type-eventsessiontitle-llm-request) |
...
| `event:user/message` | event | `0620d01028827bca4cac6c6ae7894fd34681f70b41402e0c48ac6aaf301f2b75` | [`event:user/message`](#persistence-type-eventusermessage) |
...
Sources: [`packages/core/session/src/types.ts:430`](../packages/core/session/src/types.ts) · [`packages/core/session/src/types.ts:437`](../packages/core/session/src/types.ts) · [`packages/core/session/src/types.ts:472`](../packages/core/session/src/types.ts) · [`packages/core/session/src/types.ts:503`](../packages/core/session/src/types.ts)
...
Source: [`packages/interaction/permission-presets/src/index.ts:64`](../packages/interaction/permission-presets/src/index.ts)
...
Source: [`packages/core/session/src/types.ts:426`](../packages/core/session/src/types.ts)
...
SHA-256: `989d6d8ca9c21c4c5c0e7bbf88ca575e4165221454524cdeb7dc824fdc6b5b0c`
...
SHA-256: `9840831d5ab4eeaf69a13a5b16afe62bf3ab52e3044c5ecef05c723ed93666e0`
...
SHA-256: `846b5300429cfe7714847172ffdc620b1e33b8eff8aba0e1f8df412290de27a1`
...
Sources: [`packages/core/session/src/types.ts:210`](../packages/core/session/src/types.ts) · [`packages/interaction/commands/src/types.ts:75`](../packages/interaction/commands/src/types.ts) · [`packages/interaction/commands/src/types.ts:79`](../packages/interaction/commands/src/types.ts) · [`packages/llm/llm/src/message.ts:102`](../packages/llm/llm/src/message.ts) · [`packages/session/session-title/src/index.ts:56`](../packages/session/session-title/src/index.ts)
...
<a id="persistence-type-eventagentinboxspliceddatainserted0source11gatewayexecutionscopeinputs"></a>

### `event:agent/inbox/spliced.data.inserted[0].source[11].gatewayExecutionScope.inputs`
...
| `texts` | required | [`event:agent/inbox/spliced.data.inserted[0].source[11].gatewayExecutionScope.inputs`](#persistence-type-eventagentinboxspliceddatainserted0source11gatewayexecutionscopeinputs) |
...
| Property | Presence | Type |
|---|---|---|
| `args` | required | [`event:agent/inbox/spliced.data.inserted[0].source[11].gatewayExecutionScope.inputs`](#persistence-type-eventagentinboxspliceddatainserted0source11gatewayexecutionscopeinputs) |
| `dt` | required | [`SessionEventEnvelope[39].sourceEventSeqs`](#persistence-type-sessioneventenvelope39sourceeventseqs) |
| `id` | required | `string` |
| `index` | required | `number` |
...
Sources: [`packages/core/session/src/types.ts:234`](../packages/core/session/src/types.ts) · [`packages/llm/llm/src/types.ts:147`](../packages/llm/llm/src/types.ts)
...
Sources: [`packages/llm/llm/src/types.ts:146`](../packages/llm/llm/src/types.ts)
...
Sources: [`packages/core/session/src/types.ts:346`](../packages/core/session/src/types.ts)
...
Sources: [`packages/core/session/src/types.ts:81`](../packages/core/session/src/types.ts)
...
Sources: [`packages/interaction/permission-presets/src/index.ts:64`](../packages/interaction/permission-presets/src/index.ts)
...
Sources: [`packages/core/session/src/types.ts:426`](../packages/core/session/src/types.ts)
...
SHA-256: `4b7fbf29e0ae1e0d95b75903193114fce97ad18351c41a2e06bc287d86e86333`
...
SHA-256: `ced694e523069ab73a958657b82d9288c4ffd45e0da3e0fc3e208f38f6d0cbae`
...
Sources: [`packages/core/session/src/types.ts:323`](../packages/core/session/src/types.ts) · [`packages/core/session/src/types.ts:325`](../packages/core/session/src/types.ts)
...
Sources: [`packages/core/session/src/types.ts:388`](../packages/core/session/src/types.ts)
...
Sources: [`packages/core/session/src/types.ts:384`](../packages/core/session/src/types.ts) · [`packages/core/tools/src/types.ts:24`](../packages/core/tools/src/types.ts)
...
Sources: [`packages/core/session/src/types.ts:216`](../packages/core/session/src/types.ts)
...
SHA-256: `0620d01028827bca4cac6c6ae7894fd34681f70b41402e0c48ac6aaf301f2b75`
...
Sources: [`packages/llm/llm/src/types.ts:62`](../packages/llm/llm/src/types.ts) · [`packages/web/web-search-deepseek/src/provider.ts:75`](../packages/web/web-search-deepseek/src/provider.ts)
...
Sources: [`packages/core/session/src/types.ts:48`](../packages/core/session/src/types.ts)
...
| Property | Presence | Type |
|---|---|---|
| `inputs` | required | [`event:agent/inbox/spliced.data.inserted[0].source[11].gatewayExecutionScope.inputs`](#persistence-type-eventagentinboxspliceddatainserted0source11gatewayexecutionscopeinputs) |
...
Sources: [`packages/core/session/src/types.ts:278`](../packages/core/session/src/types.ts)
...
SHA-256: `8102d6727bb57bbea3bb78b5622996246ae4609d0bddf332ef0f2c6657493dad`

Sources: [`packages/core/session/src/types.ts:111`](../packages/core/session/src/types.ts)
...
| Property | Presence | Type |
|---|---|---|
| `allow` | optional | [`event:agent/inbox/spliced.data.inserted[0].source[11].gatewayExecutionScope.inputs`](#persistence-type-eventagentinboxspliceddatainserted0source11gatewayexecutionscopeinputs) |
| `deny` | optional | [`event:agent/inbox/spliced.data.inserted[0].source[11].gatewayExecutionScope.inputs`](#persistence-type-eventagentinboxspliceddatainserted0source11gatewayexecutionscopeinputs) |
...
| Property | Presence | Type |
|---|---|---|
| `blockedBy` | required | [`event:agent/inbox/spliced.data.inserted[0].source[11].gatewayExecutionScope.inputs`](#persistence-type-eventagentinboxspliceddatainserted0source11gatewayexecutionscopeinputs) |
| `description` | required | `string` |
| `id` | required | `string` |
...
| `writeScopes` | required | [`event:agent/inbox/spliced.data.inserted[0].source[11].gatewayExecutionScope.inputs`](#persistence-type-eventagentinboxspliceddatainserted0source11gatewayexecutionscopeinputs) |
...
| `provider` | required | `string` |
| `reasoningEffort` | optional | `string` |
| `stop` | optional | [`event:agent/inbox/spliced.data.inserted[0].source[11].gatewayExecutionScope.inputs`](#persistence-type-eventagentinboxspliceddatainserted0source11gatewayexecutionscopeinputs) |
...
SHA-256: `a956a7c8efef3df4a209727ae6bbc15a2ffc9dc84a9bd0a2b7039be73db42d11`
...
SHA-256: `7d8dbc9499b004eab37de797380f8cf73f096fe8dadd87b6fce609c123086df1`
...
Sources: [`packages/llm/llm/src/message.ts:163`](../packages/llm/llm/src/message.ts)
...
SHA-256: `2ed5dd210d1416c57564f8329e980a0aefe3bfc1393be38ca093866c1d82f663`
...
Sources: [`packages/llm/llm/src/types.ts:138`](../packages/llm/llm/src/types.ts)
...
Sources: [`packages/llm/llm/src/types.ts:153`](../packages/llm/llm/src/types.ts)
...
SHA-256: `becb738db5b4c2865a69cc40df806519d781feea1ab1b3d177539b5b9188ec66`
...
SHA-256: `c5f16f18b8294aaca4f35f5bec64b52291993f56aa967cc493482fc7d42fdd3a`

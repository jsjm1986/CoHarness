...
Source: [`packages/acp/acp/src/index.ts:73`](../packages/acp/acp/src/index.ts)
...
Source: [`packages/client/connection/src/index.ts:83`](../packages/client/connection/src/index.ts)
...
<a id="deepseek-aidsh-gateway-execution"></a>

## `@deepseek-ai/dsh-gateway-execution`

Requires: `gatewayRuntime` · `agents` · `sessions` · `sessionQuery` · `permissionPresets` · `sandboxPolicy` · `sessionProjections`
...
Source: [`packages/goal/goal/src/index.ts:174`](../packages/goal/goal/src/index.ts)
...
Source: [`packages/host/directory-picker-browse/src/index.ts:271`](../packages/host/directory-picker-browse/src/index.ts)
...
Source: [`packages/host/open-in-app/src/index.ts:47`](../packages/host/open-in-app/src/index.ts)
...
Source: [`packages/test-support/llm-replay/src/index.ts:1027`](../packages/test-support/llm-replay/src/index.ts)
...
Source: [`packages/feedback/message-feedback/src/index.ts:51`](../packages/feedback/message-feedback/src/index.ts)
...
Source: [`packages/boot/plugin-manager/src/index.ts:35`](../packages/boot/plugin-manager/src/index.ts)
...
Source: [`packages/session/session-log-deepseek/src/index.ts:34`](../packages/session/session-log-deepseek/src/index.ts)

<a id="deepseek-aidsh-session-persistence-gateway"></a>

## `@deepseek-ai/dsh-session-persistence-gateway`

Requires: `sessions` · `gatewayRuntime`
...
Source: [`packages/session/session-persistence-gateway/src/index.ts:90`](../packages/session/session-persistence-gateway/src/index.ts)
...
Source: [`packages/session/session-persistence-sqlite/src/index.ts:42`](../packages/session/session-persistence-sqlite/src/index.ts)
...
Source: [`packages/session/session-projection-cache/src/index.ts:62`](../packages/session/session-projection-cache/src/index.ts)
...
Source: [`packages/subagent/subagent-acp/src/index.ts:38`](../packages/subagent/subagent-acp/src/index.ts)
...
export interface Config {
  ...
  disposeGraceMs?: number
  /**
   * Directory holding the member binding store (`<stateDir>/claude-code.jsonl`),
...
export interface Config {
  ...
  disposeGraceMs?: number
  /**
   * Directory holding the member binding store (`<stateDir>/codex.jsonl`),
...
Source: [`packages/web/web-search-exa/src/index.ts:41`](../packages/web/web-search-exa/src/index.ts)
...
- `@deepseek-ai/dsh-collaboration-context` — requires `agents` ([`packages/context/collaboration-context/src/index.ts`](../packages/context/collaboration-context/src/index.ts))
- `@deepseek-ai/dsh-collaboration-gateway` — requires `gatewayRuntime` ([`packages/context/collaboration-gateway/src/index.ts`](../packages/context/collaboration-gateway/src/index.ts))
...
- `@deepseek-ai/dsh-gateway-runtime` — requires `connection` ([`packages/context/gateway-runtime/src/index.ts`](../packages/context/gateway-runtime/src/index.ts))
...
- `@deepseek-ai/dsh-collaboration` — abstract `Collaboration` ([`packages/context/collaboration/src/index.ts`](../packages/context/collaboration/src/index.ts))
...
- `@deepseek-ai/dsh-execution-authority` — abstract `ExecutionAuthority` ([`packages/context/execution-authority/src/index.ts`](../packages/context/execution-authority/src/index.ts))
...
- `@deepseek-ai/dsh-model-access` — abstract `ModelAccessPolicy` ([`packages/llm/model-access/src/index.ts`](../packages/llm/model-access/src/index.ts))
- `@deepseek-ai/dsh-model-provider-config` — abstract `ModelProviderConfig` ([`packages/llm/model-provider-config/src/index.ts`](../packages/llm/model-provider-config/src/index.ts))
...
- `@deepseek-ai/dsh-session-format-v5-to-v6` ([`packages/session/session-format-v5-to-v6/src/index.ts`](../packages/session/session-format-v5-to-v6/src/index.ts))

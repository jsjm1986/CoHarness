...
Requires: `gatewayRuntime` · `agents` · `sessions` · `sessionQuery` · `permissionPresets` · `sandboxPolicy`
...
Source: [`packages/context/gateway-execution/src/index.ts:22`](../packages/context/gateway-execution/src/index.ts)

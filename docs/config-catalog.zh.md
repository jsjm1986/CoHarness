...
export interface AcpConfig {
  ...
  /** Runtime-only transport override; the caller owns its lifecycle when supplied. */
  stream?: Stream
}
```
...
来源：[`packages/goal/goal/src/index.ts:174`](../packages/goal/goal/src/index.ts)
...
依赖：`Api`（`@earendil-works/pi-ai`）· `CacheRetention`（`@earendil-works/pi-ai`）· `Model`（`@earendil-works/pi-ai`）· `ModelThinkingLevel`（`@earendil-works/pi-ai`）· `OpenAICompletionsCompat`（`@earendil-works/pi-ai`）· [`RetryPolicyConfig`](../packages/llm/llm/src/index.ts) · `ThinkingBudgets`（`@earendil-works/pi-ai`）· `ThinkingTokenBudgetField`（`@earendil-works/pi-ai`）· `Transport`（`@earendil-works/pi-ai`)
...
来源：[`packages/test-support/llm-replay/src/index.ts:817`](../packages/test-support/llm-replay/src/index.ts)
...
<a id="deepseek-aidsh-session-persistence-gateway"></a>

## `@deepseek-ai/dsh-session-persistence-gateway`

需要：`sessions` · `gatewayRuntime`
...
来源：[`packages/session/session-persistence-gateway/src/index.ts:87`](../packages/session/session-persistence-gateway/src/index.ts)
...
来源：[`packages/session/session-persistence-sqlite/src/index.ts:41`](../packages/session/session-persistence-sqlite/src/index.ts)
...
来源：[`packages/subagent/subagent/src/index.ts:167`](../packages/subagent/subagent/src/index.ts)
...
依赖：[`ReasoningEffortId`](../packages/llm/llm/src/index.ts)
...
来源：[`packages/core/system-prompt/src/index.ts:233`](../packages/core/system-prompt/src/index.ts)
...
来源：[`packages/context/time-context/src/index.ts:28`](../packages/context/time-context/src/index.ts)
...
需要：`tools` · `systemPrompt` · `userDocs`
...
来源：[`packages/attachment/tool-userdoc/src/index.ts:42`](../packages/attachment/tool-userdoc/src/index.ts)
...
- `@deepseek-ai/dsh-archive-gateway` — 需要 `connection` · `gatewayRuntime` · `workspaceRegistry`（[`packages/context/archive-gateway/src/index.ts`](../packages/context/archive-gateway/src/index.ts)）
...
- `@deepseek-ai/dsh-client-ui-documents`（[`packages/client/ui-documents/src/index.ts`](../packages/client/ui-documents/src/index.ts)）
...
- `@deepseek-ai/dsh-client-ui-usage-alert`（[`packages/client/ui-usage-alert/src/index.ts`](../packages/client/ui-usage-alert/src/index.ts)）
- `@deepseek-ai/dsh-client-ui-user-questions`（[`packages/client/ui-user-questions/src/index.ts`](../packages/client/ui-user-questions/src/index.ts)）
- `@deepseek-ai/dsh-client-ui-workflow-run`（[`packages/client/ui-workflow-run/src/index.ts`](../packages/client/ui-workflow-run/src/index.ts)）
- `@deepseek-ai/dsh-client-ui-workspace`（[`packages/client/ui-workspace/src/index.ts`](../packages/client/ui-workspace/src/index.ts)）
- `@deepseek-ai/dsh-collaboration-context` — 需要 `agents`（[`packages/context/collaboration-context/src/index.ts`](../packages/context/collaboration-context/src/index.ts)）
- `@deepseek-ai/dsh-collaboration-gateway` — 需要 `gatewayRuntime`（[`packages/context/collaboration-gateway/src/index.ts`](../packages/context/collaboration-gateway/src/index.ts)）
...
- `@deepseek-ai/dsh-gateway-runtime` — 需要 `connection`（[`packages/context/gateway-runtime/src/index.ts`](../packages/context/gateway-runtime/src/index.ts)）
...
- `@deepseek-ai/dsh-userdoc-context` — 需要 `agents` · `sessions`（[`packages/context/userdoc-context/src/index.ts`](../packages/context/userdoc-context/src/index.ts)）
...
- `@deepseek-ai/dsh-collaboration` — 抽象 `Collaboration`（[`packages/context/collaboration/src/index.ts`](../packages/context/collaboration/src/index.ts)）
...
- `@deepseek-ai/dsh-model-access` — 抽象 `ModelAccessPolicy`（[`packages/llm/model-access/src/index.ts`](../packages/llm/model-access/src/index.ts)）
- `@deepseek-ai/dsh-model-provider-config` — 抽象 `ModelProviderConfig`（[`packages/llm/model-provider-config/src/index.ts`](../packages/llm/model-provider-config/src/index.ts)）

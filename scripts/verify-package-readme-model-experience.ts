...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  'packages/api/terminal-controller': { kind: 'none', reason: 'Human terminal input and output are private to the user and excluded from model requests.' },
  'packages/client/ui-sidebar-terminal': { kind: 'none', reason: 'The sidebar presents human terminal output without adding model input.' },
  'packages/util/deque': { kind: 'none', reason: 'The in-process collection registers no model-facing content.' },
  ...
  'packages/deliverables/workspace-changes': { kind: 'none', reason: 'The recorder appends log-only Session events for clients and registers no model-facing content.' },
  'packages/client/ui-dockkit': { kind: 'none', reason: 'Browser docking and layout primitives register no model-visible content.' },
  'packages/client/ui-sidebar-browser': { kind: 'none', reason: 'Browser tabs register no model-visible content.' },
  'packages/client/ui-sidebar-right': { kind: 'none', reason: 'Auxiliary tab navigation and resource presentation register no model-visible content.' },
  ...
  'packages/attachment/userdoc-local': { kind: 'indirect', reason: 'The local backend stores the file and delegates every model-visible rendering decision to the host prompt-assembly consumer.' },
  ...
  'packages/ptc-runtime/ptc-runtime': { kind: 'indirect', reason: 'The service interface delegates model rendering to PTC in dsh-tools.' },
  ...
  'packages/client/userdoc-upload': { kind: 'none', reason: 'Browser-side document transport library; moves file bytes and registers nothing model-facing.' },
  ...
  'packages/client/ui-collaboration': { kind: 'indirect', reason: 'The browser UI selects collaboration state; host collaboration consumers own authorization and participant attribution.' },
  ...
  'packages/extensions/ui-cordis': { kind: 'indirect', reason: 'Historical definition cards and browser controls present the host runner; the runner owns any model-visible effect.' },
  ...
  'packages/client/ui-settings-unarchive-sessions': { kind: 'none', reason: 'Browser-side archived-sessions restore surface; registers no model-facing content.' },
  ...
  'packages/host/userdoc-http': { kind: 'none', reason: 'The streaming browser transport stores and retrieves files; a session consumer owns any model-visible rendering.' },
  ...
  'packages/context/execution-authority': { kind: 'none', reason: 'The Service Definition registers no prompt or tool.' },
  'packages/context/gateway-execution': { kind: 'none', reason: 'The Gateway provider controls execution admission without adding identity metadata to model content.' },
  ...
  'packages/test-support/session-snapshot': { kind: 'none', reason: 'The test harness records, normalizes, and compares profile sessions without changing the assembled model request.' },
  ...
  'packages/util/crypto': { kind: 'indirect', reason: 'Identifier and byte-encoding helpers affect only host/client transport values; consumers own any model-visible request behavior.' },
  'packages/util/time': { kind: 'indirect', reason: 'Zone canonicalization returns a durable string; the consumer recording it and dsh-time-context own the model-visible zone instruction.' },

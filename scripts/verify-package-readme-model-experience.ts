...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/code-runtime/code-runtime': { kind: 'indirect', reason: 'The service interface delegates model rendering to PTC in dsh-tools.' },
  ...
  'packages/code-runtime/code-runtime-worker-thread': { kind: 'indirect', reason: 'The worker backend delegates model rendering to PTC in dsh-tools.' },
  'packages/experimental/code-runtime-python': { kind: 'indirect', reason: 'The experimental CPython subprocess backend delegates model rendering to PTC in dsh-tools.' },

...
function parseMode(raw: string | undefined): Mode {
  switch (raw) {
    ...
    default:
      throw new Error(
        `run-gates: expected mode ci-primary | ci-linux-primary | ci-static | ci-lint-contracts-ready | ci-coverage | ci-coverage-scoped | ci-bench | ci-snapshot | ci-artifacts | ci-consumers | ci-consumers-scoped | ci-web-focused | ci-web-full | ci-windows-blocking | ci-windows-complete | ci-windows-observational | node-compat | check-all | hygiene | doc-sync | doc-quick, got ${JSON.stringify(raw)}.`,
      )
  }
}

...
function docSyncLeafGates(options: {
  ...
  return [
    ...
    pnpmScript('repository-references', 'verify-repository-references', { label: 'repository references' }),
    pnpmScript('dependency-catalog', 'verify-dependency-catalog', { label: 'npm dependency catalog' }),

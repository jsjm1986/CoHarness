...
export const SERVICE_PAGE: Record<string, string> = {
  ...
  modelProviderConfig: 'llm-streaming.md',
...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  CollaborationInteractionKind: 'collaboration.md',
  CollaborationParticipant: 'collaboration.md',
  CollaborationSessionCreation: 'collaboration.md',
  CollaborationVisibility: 'collaboration.md',
  ConnectionRequestBoundary: 'collaboration.md',
  ...
  ManagedModelProfile: 'llm-streaming.md',
  ManagedModelProviderProfile: 'llm-streaming.md',
  ManagedModelProviderProtocol: 'llm-streaming.md',
  ModelAccessTarget: 'llm-streaming.md',
  ModelAccessDecision: 'llm-streaming.md',
  ModelProviderConfigSnapshot: 'llm-streaming.md',
  ...
  BeginUserDocUpload: 'attachment.md',
  UserDocDirectoryId: 'attachment.md',
  UserDocDirectoryListing: 'attachment.md',
  UserDocDirectoryPage: 'attachment.md',
  UserDocDirectoryRef: 'attachment.md',
  UserDocId: 'attachment.md',
  UserDocListQuery: 'attachment.md',
  UserDocTrashPage: 'attachment.md',
  UserDocTrashRef: 'attachment.md',
  UserDocUploadCapabilities: 'attachment.md',
  UserDocUploadChunk: 'attachment.md',
  UserDocUploadId: 'attachment.md',
  UserDocUploadSession: 'attachment.md',
  UserDocUploadState: 'attachment.md',
  ...
  GoalRef: 'goal.md',
  GoalView: 'goal.md',
  GatewayPrincipalClaims: 'collaboration.md',
  GatewayPrincipalScope: 'collaboration.md',
  GatewayRequestPrincipal: 'collaboration.md',
  GatewayRuntimeCredential: 'collaboration.md',
  GatewayRuntimeIdentity: 'collaboration.md',
  ...
  SessionAccessType: 'persistence.md',
  SessionHandleType: 'persistence.md',
  ...
  SessionPersistencePage: 'persistence.md',
  SessionPersistencePageRequest: 'persistence.md',
  SessionHistoryIndex: 'persistence.md',
  SessionHistoryIndexItem: 'persistence.md',
  SessionContentMetadata: 'persistence.md',
  SessionDraftReservation: 'persistence.md',
  SessionDraftReservationRequest: 'persistence.md',
  ...
  SubagentPromptContentPart: 'subagent.md',
  ...
  ToolPresentationModeInput: 'tools.md',
  ...
  ReadOnlyCredentialLayer: 'credentials.md',
...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  ContractSessionHandle: 'contract-backed write handle is owned by packages/session/session-persistence/src/index.ts',
  LegacySessionHandle: 'legacy write handle contract is owned by packages/session/session-persistence/README.md',
  ...
  CompositionRowEnablement: 'preset composition enablement is owned by packages/preset/agent-presets/README.md',
  ...
  DeepSeekLlmApiExtensionMap: 'request-extension registry vocabulary is owned by packages/llm/deepseek-llm-api-extensions/README.md',
  DeepSeekLlmApiExtensionProvider: 'request-extension provider contract is owned by packages/llm/deepseek-llm-api-extensions/README.md',
  DeepSeekLlmApiExtensionRequest: 'request-extension input contract is owned by packages/llm/deepseek-llm-api-extensions/README.md',
  PreparedDeepSeekLlmApiExtensions: 'prepared request-extension transaction is owned by packages/llm/deepseek-llm-api-extensions/README.md',

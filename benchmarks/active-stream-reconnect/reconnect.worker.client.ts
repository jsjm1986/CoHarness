...
import type { SessionAssistantStreamBaseline } from '@deepseek-ai/dsh-host-apiproxy/api'
// The Client implementation has no plain-Node export; only this adapter is bundled.
import { ClientAssistantStream } from '../../packages/client/runtime/src/client/sessions/assistant-stream.ts'

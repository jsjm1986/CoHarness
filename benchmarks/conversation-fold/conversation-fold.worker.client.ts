...
import { ConversationNodeAssembler } from '../../packages/client/runtime/src/client/sessions/conversation-assembler.ts'
import { assistantDefinition } from '../../packages/client/ui-conversation/src/client/conversation-nodes/assistant.ts'
import { chatViewDefinition } from '../../packages/client/ui-conversation/src/client/conversation-nodes/chat-snapshot-builder.ts'
import { commandDefinition } from '../../packages/client/ui-conversation/src/client/conversation-nodes/command.ts'
import { compactionDefinition } from '../../packages/client/ui-conversation/src/client/conversation-nodes/compaction.ts'
import { unknownFallbackDefinition } from '../../packages/client/ui-conversation/src/client/conversation-nodes/fallback.ts'
import { nextStepInboxDefinition } from '../../packages/client/ui-conversation/src/client/conversation-nodes/inbox.ts'
import { messageDefinition } from '../../packages/client/ui-conversation/src/client/conversation-nodes/message.ts'
import { retryDefinition } from '../../packages/client/ui-conversation/src/client/conversation-nodes/retry.ts'
import { systemPromptDefinition } from '../../packages/client/ui-conversation/src/client/conversation-nodes/system-prompt.ts'
import { toolDefinition } from '../../packages/client/ui-conversation/src/client/conversation-nodes/tool.ts'
import { turnErrorDefinition } from '../../packages/client/ui-conversation/src/client/conversation-nodes/turn-error.ts'
import { turnMaxTokensDefinition } from '../../packages/client/ui-conversation/src/client/conversation-nodes/turn-max-tokens.ts'
import { turnProcessDefinition } from '../../packages/client/ui-conversation/src/client/conversation-nodes/turn-process.ts'
import { turnTailDefinition } from '../../packages/client/ui-conversation/src/client/conversation-nodes/turn-tail.ts'
...
function entry(seq: number, type: string, data: unknown, extra: Record<string, unknown> = {}): ConversationEventInput {
  return {
...
function synthesizeWindow(
  turns: number,
  deltas: number,
): { readonly entries: readonly ConversationEventInput[]; readonly records: number } {
...
function foldOnce(entries: readonly ConversationEventInput[]): { readonly ms: number; readonly nodes: number } {
